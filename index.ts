...
function getFrequencyTypeSegment(domain: string): any {
    ...
    function isFrequencyTypeSegment(domain: string, segmentID: string): boolean {
        /**
         * array: frequencyUsers
         * for all frequency values in segentID-Array
         */
        const frequencyUsers = ['lowfrequencyUser', 'mediumfrequencyUser', 'highfrequencyUser'];
    ...
    segmentIDs.forEach(function (segmentID: string) {
